...
class Corpus(object):
    def __init__(self, path):
        ...
        self.train = self.tokenize(os.path.join(path, 'train.sn-en.sn'))
        self.valid = self.tokenize(os.path.join(path, 'valid.sn-en.sn'))
        self.test = self.tokenize(os.path.join(path, 'test.sn-en.sn'))
